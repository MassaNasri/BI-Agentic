...
def build_ai_trace_payload(
    *,
    ...
    preprocessing_high_status = _normalize_status(pre_high_stage.get("status") or "success")
    ...
    trace = {
        ...
        "preprocessing_low": {
            "status": _normalize_status(classification_stage.get("status") or "success"),
